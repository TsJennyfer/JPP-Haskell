...
class Game {
    ...
    public void sendPlayerList() {
        ...
        for ( Player player : players.values() ) {
            playersStr += player.sessionId + " " + player.x + " " + player.y + " ";
        }
        
        String playerSendBuff = "PLAYERS " + playersStr ;
        ...
        for( Player player : players.values() ){
            ...
            if( player.inputLast !=null && !player.inputLast.isEmpty()){
                if(!winnerBuff.isEmpty()){
                    ...
                    playerSendBuff = player.lastOperationStatus + " WIN " + buff + " " +round ;
                    player.output.println(playerSendBuff);
                    ...
                    playerSendBuff = player.lastOperationStatus + " LOST " + buff +  " " +round ;
                    ...
                    playerSendBuff = player.lastOperationStatus + " BOARD " + buff + " " +round;
               ...
               char direction = player.dir.charAt(0);
                ...
                switch(direction){
                    case 'S':{
                        ...
                        else player.lastOperationStatus = "ERROR";
                        break;
                    }
                    case 'N':{
                        if(isValidMove( player, player.x, player.y-1 )){
                    ...
                    default: {
                        player.lastOperationStatus = "ERROR";
                    }
                }
